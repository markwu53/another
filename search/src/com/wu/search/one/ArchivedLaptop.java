...
public class ArchivedLaptop implements Serializable {
        ...
        public ArchivedLaptop() {
                inStock = true;
        }

        public ArchivedLaptop(StaplesLaptop a) {
                itemId = a.getItemId();
                model = a.getModel();
                href = a.getHref();
                rating = a.getRating();
                ...
                spec = a.getSpec();
                priceOrig = a.getPriceOrig();
                priceSave = a.getPriceSave();
                instantSave = a.getInstantSave();
                rebate = a.getRebate();
                priceFinal = a.getPriceFinal();
                priceOrig2 = a.getPriceOrig2();
                priceFinal2 = a.getPriceFinal2();
                priceSave2 = a.getPriceSave2();
                version = a.getVersion();
                inStock = a.getInStock();
        }
